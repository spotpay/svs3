...
get '/test' do
  ...
  <body>
   <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553538500" 
      codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0"     
      id="FlashObjectIE" type="application/x-shockwave-flash" height="385" width="640">
      <param name="movie" value="/TestHarness.swf?width=640&height=385&load_url=/SVS3.swf&bkg_img=/youtube.png&child_y=275&child_x=0">
      <param name="quality" value="high">
      <embed id="FlashObjectFF" src="/TestHarness.swf?width=640&height=385&load_url=/SVS3.swf&bkg_img=/youtube.png&child_y=275&child_x=0"
            quality="high" name="Musicane" type="application/x-shockwave-flash" 
            pluginspage="http://www.macromedia.com/go/getflashplayer" height="385" width="640">
      </embed>
    </object>
  </body>
doc
